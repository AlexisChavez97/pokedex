  ...
  class Client
    ...
    def connection
      @connection ||= Faraday.new(BASE_URL, proxy: sample_proxy ) do |connection|
        connection.headers["User-Agent"] = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36"
        connection.headers["Referer"] = "https://www.pokemon.com"
        connection.headers["Accept-Language"] = "en-US,en;q=0.9"
        connection.headers["Accept"] = "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,*/*;q=0.8"
